...
public class LeaveCountController {
    ...
    @CrossOrigin(origins = "*")
    @PostMapping(path = "/setNewEmployee",produces = "application/json",consumes = "application/json")
    public HashMap<String,String> InitializeNewEmployee(@RequestBody LeaveCount l)
    {
        ...
        map.put("status","employee added to leave count table");
    ...
    public HashMap<String,String> ReduceLeaveCount(@RequestBody LeaveCount l)
    {
        ...
        if(Objects.equals(l.getLeaveType(), "Casual"))
        {
            if(l.getCasualLeave()>0)
            {
                ...
                map.put("remaining casual leaves are ",String.valueOf(l.getCasualLeave()));
        ...
        } else if (Objects.equals(l.getLeaveType(), "Sick"))
        {
            if(l.getSickLeave()>0)
            {
                ...
                map.put("remaining sick leaves are",String.valueOf(l.getSickLeave()));
            }
            else
            {
        ...
        else
        {
            if(l.getSpecialLeave()>0)
            {
                ...
                map.put("remaining special leaves are ",String.valueOf(l.getSpecialLeave()));
            }
            else
            {
