...
import com.example.nestdigitalAppnew_backend.dao.EmployeeLogsDao;
import com.example.nestdigitalAppnew_backend.model.EmployeeLogs;
...
public class EmployeeLogsController {
    ...
    @CrossOrigin(origins = "*")
    @PostMapping(path = "/employeeEntryAdd",produces = "application/json",consumes = "application/json")
    public HashMap<String,String> AddEmployeeEntry(@RequestBody EmployeeLogs el)
    {
        ...
        map.put("status","employee entry added");

        return map;
    }

    @CrossOrigin(origins = "*")
    @PostMapping(path = "/employeeExitAdd",produces = "application/json",consumes = "application/json")
    public HashMap<String,String> AddEmployeeExit(@RequestBody EmployeeLogs el)
    {
        ...
        map.put("status","employee exit added");
